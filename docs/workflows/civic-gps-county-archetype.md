...
Brazos's v0.1 geography/office candidate package contains 18 canonical offices / 18 holders = 6 deliberately bounded countywide + 4 Commissioner + 4 JP + 4 Constable. All three district families share the official P1–P4 geometry and use the generic one-meter topology probe. Action routing remains `NOT_YET_RELEASED`; additional countywide and judicial offices remain `BOUNDED_V0_1_SCOPE`; protected promotion remains a separate `CG-10` gate.
