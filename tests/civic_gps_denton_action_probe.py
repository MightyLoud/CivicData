#!/usr/bin/env python3
"""Deterministic Denton action-selection contract for Civic GPS v0.6.1 / registry v0.5.5."""
...
if registry.get("registry_artifact_version") != "0.5.5":
    raise AssertionError(f"Expected registry 0.5.5, got {registry.get('registry_artifact_version')}")
