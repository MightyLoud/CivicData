#!/usr/bin/env python3
"""Deterministic Denton action-selection contract for Civic GPS v0.6.0 / registry v0.5.1."""
...
if registry.get("registry_artifact_version") != "0.5.1":
    raise AssertionError(f"Expected registry 0.5.1, got {registry.get('registry_artifact_version')}")
