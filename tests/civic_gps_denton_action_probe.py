#!/usr/bin/env python3
"""Deterministic Denton action-selection contract for Civic GPS v0.6.2 / registry v0.5.7."""
...
if registry.get("registry_artifact_version") != "0.5.7":
    raise AssertionError(f"Expected registry 0.5.7, got {registry.get('registry_artifact_version')}")
