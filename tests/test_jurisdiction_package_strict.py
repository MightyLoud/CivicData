"""PR #47 strict jurisdiction-package contract regression wrapper."""
...
try:
    _IMPL = ROOT / "tests" / "_pr47_jurisdiction_package_strict_impl.py"
    _namespace = runpy.run_path(str(_IMPL), run_name="pr47_jurisdiction_package_strict")
finally:
