#!/usr/bin/env python3
"""Packaged Denton County live controls for Civic GPS v0.6.1 / registry v0.5.4."""
...
if registry.get("registry_artifact_version") != "0.5.4":
    raise AssertionError(f"Expected packaged registry 0.5.4, got {registry.get('registry_artifact_version')}")
