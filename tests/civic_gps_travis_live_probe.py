...
if registry.get("engine_version") != "0.6.2" or registry.get("registry_artifact_version") != "0.5.8":
    raise AssertionError(
        f"Travis release proof requires engine 0.6.2 / registry 0.5.8, got "
